...
("MaxDisconnectionTime",
 _("Terminate when no client has been connected for s seconds"),
 0, 0, INT_MAX);
core::IntParameter rfb::Server::maxConnectionTime
("MaxConnectionTime",
 _("Terminate when a client has been connected for s seconds"),
 0, 0, INT_MAX);
core::IntParameter rfb::Server::maxIdleTime
("MaxIdleTime",
 _("Terminate after s seconds of user inactivity"),
 0, 0, INT_MAX);
...
("AcceptKeyEvents",
 _("Accept key press and release events from clients"),
 true);
core::BoolParameter rfb::Server::acceptPointerEvents
("AcceptPointerEvents",
 _("Accept pointer movement and button events from clients"),
 true);
core::BoolParameter rfb::Server::acceptCutText
("AcceptCutText",
 _("Accept clipboard updates from clients"),
 true);
