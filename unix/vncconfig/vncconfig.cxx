...
public:
  VncConfigWindow(Display* dpy_)
    : TXWindow(dpy_, 300, 100),
      acceptClipboard(dpy_, _("Accept clipboard changes from clients"), this, false, this),
      setPrimaryCB(dpy_, _("Also set primary selection"), this, false, this),
      sendClipboard(dpy_, _("Send clipboard to clients"), this, false, this),
      sendPrimaryCB(dpy_, _("Send primary selection to clients"), this,false,this),
