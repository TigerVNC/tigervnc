...
${OBJECTDIR}/CConn.o: CConn.cxx
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CConn.o CConn.cxx

${OBJECTDIR}/DesktopWindow.o: DesktopWindow.cxx
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DesktopWindow.o DesktopWindow.cxx

${OBJECTDIR}/OptionsDialog.o: OptionsDialog.cxx
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OptionsDialog.o OptionsDialog.cxx

${OBJECTDIR}/PlatformPixelBuffer.o: PlatformPixelBuffer.cxx
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PlatformPixelBuffer.o PlatformPixelBuffer.cxx

${OBJECTDIR}/ServerDialog.o: ServerDialog.cxx
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ServerDialog.o ServerDialog.cxx

${OBJECTDIR}/Surface.o: Surface.cxx
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Surface.o Surface.cxx

${OBJECTDIR}/Surface_OSX.o: Surface_OSX.cxx
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Surface_OSX.o Surface_OSX.cxx

${OBJECTDIR}/Surface_Win32.o: Surface_Win32.cxx
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Surface_Win32.o Surface_Win32.cxx

${OBJECTDIR}/Surface_X11.o: Surface_X11.cxx
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Surface_X11.o Surface_X11.cxx

${OBJECTDIR}/UserDialog.o: UserDialog.cxx
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UserDialog.o UserDialog.cxx

${OBJECTDIR}/Viewport.o: Viewport.cxx
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Viewport.o Viewport.cxx

${OBJECTDIR}/cocoa.o: cocoa.mm
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cocoa.o cocoa.mm

${OBJECTDIR}/menukey.o: menukey.cxx
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/menukey.o menukey.cxx

${OBJECTDIR}/parameters.o: parameters.cxx
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/parameters.o parameters.cxx

${OBJECTDIR}/vncviewer.o: vncviewer.cxx
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/vncviewer.o vncviewer.cxx
