...
KeyboardMacOS::KeyboardMacOS(KeyboardHandler* handler)
  : Keyboard(handler)
{
}
...
rdr::U32 KeyboardMacOS::translateToKeyCode(int systemKeyCode)
{
...
std::list<rdr::U32> KeyboardMacOS::translateToKeySyms(int systemKeyCode)
{
...
rdr::U32 KeyboardMacOS::translateToKeySym(unsigned keyCode,
